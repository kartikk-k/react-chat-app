...
function ChatBox({ }) {
    ...
    return (
        <div className='relative w-screen'>
            ...
            <div className='relative flex-row justify-end w-full h-screen overflow-hidden'>
                {/* header */}
                <div className='flex justify-between z-40 px-2 items-center border-b h-14 bg-[#343A46] shadow-lg'>
                ...
                {/* get chat messages */}
                {!chatsLoading ? (
                    <div className='h-screen overflow-auto pb-36'>
            ...
            {/* message box */}
            {!chatsLoading && (
                <div className=' w-full fixed bottom-0 md:absolute md:bottom-14 left-0 bg-[#23272F] py-4 overflow-scroll'>
                    {messages && (
